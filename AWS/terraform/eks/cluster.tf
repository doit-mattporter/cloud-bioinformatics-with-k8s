  ...
  worker_groups_launch_template = [
    {
      ...
      kubelet_extra_args       = "--node-labels=node.kubernetes.io/lifecycle=spot,nodegroup=spot_large"
    ...
    },
    {
      ...
      asg_max_size             = 5
      asg_desired_capacity     = 1
      kubelet_extra_args       = "--node-labels=node.kubernetes.io/lifecycle=spot,nodegroup=spot_small"
      suspended_processes      = ["AZRebalance"]
    },
  ]
}
